! function(t, e) {
    "object" == typeof exports && "object" == typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define([], e) : "object" == typeof exports ? exports.BrowserFS = e() : t.BrowserFS = e()
}(this, function() {
    return function(t) {
        function e(r) {
        ...
        (function(t, r, i, o) {
            ...
            function l(t, e) {
                ...
                for (var s = new Array(r << 1), a = 0; a < r;) s[r + a] = t.charCodeAt(o + a), s[a] = ++a;
                var c, u, f, h, l;
                for (c = 0; c + 3 < i;)
                    ...
                    u = function(t) {
                        if (i.hasOwnProperty(t)) {
                            ...
                            if (void 0 === u || null === u) {
                                ...
                                var h = !1;
                                if (h = Array.isArray(c.type) ? c.type.indexOf(typeof u) !== -1 : typeof u === c.type, !h) return a ? {} : (a = !0, {
                                    v: n(new Fe(be.EINVAL, "[" + o + "] Value provided for option " + t + " is not the proper type. Expected " + (Array.isArray(c.type) ? "one of {" + c.type.join(", ") + "}" : c.type) + ", but received " + typeof u + "\nOption description: " + c.description))
                                });
            ...
            function F(t, e, n) {
                return e = Ge(void 0 === e ? t.length - 1 : e, 0),
                    function() {
                        for (var r = arguments, i = -1, o = Ge(r.length - e, 0), s = Array(o); ++i < o;) s[i] = r[e + i];
                        i = -1;
            ...
            function Y(t, e) {
                var n = On(t),
                    ...
                    c = a.length;
                for (var u in t) !e && !dr.call(t, u) || s && ("length" == u || i && ("offset" == u || "parent" == u) || o && ("buffer" == u || "byteLength" == u || "byteOffset" == u) || W(u, c)) || a.push(u);
                return a
            }
            ...
            function J(t) {
                if (!X(t)) return gr(t);
                var e = [];
                for (var n in Object(t)) mr.call(t, n) && "constructor" != n && e.push(n);
                return e
            }
            ...
            function st(t, e, n) {
                ...
                var i = 0,
                    o = 0,
                    s = t.length;
                for (0 === s && n(null); i < s; i++) e(t[i], i, nt(r))
            }
            ...
            function yt(t) {
                return R(function(e, n) {
                    e.apply(null, n.concat(R(function(e, n) {
                        "object" == typeof console && (e ? console.error && console.error(e) : console[t] && ft(n, function(e) {
                            console[t](e)
                        }))
                    })))
                })
            ...
            function Et(t) {
                return null === t || void 0 === t || "object" == typeof t && "number" == typeof t.byteLength
            }
            ...
            function Pt(t, e, n) {
                return void 0 === e && (e = be.EIO), void 0 === n && (n = null),
                    function(r) {
            ...
            function Gt(t) {
                return t && "object" == typeof t && t.hasOwnProperty("browserfsMessage") && t.browserfsMessage
            }
            ...
            function Ee(t, e) {
                ...
                if (null !== i && "object" == typeof i) {
                    ...
                    c.forEach(function(t) {
                        var r = i[t];
                        null !== r && "object" == typeof r && r.fs && (o++, Ee(r, function(r, c) {
                            if (o--, r) {
                                if (s) return;
                                s = !0, e(r)
                            } else i[t] = c, 0 === o && a && n()
            ...
            We.prototype.supportsLinks = function() {
                ...
                if (this.supportsLinks())
                    for (var r = t.split(ke.sep), i = 0; i < r.length; i++) {
                        var o = r.slice(0, i + 1);
            ...
            var Ge = Math.max,
                ...
                $e = "object" == typeof r && r && r.Object === Object && r,
                ...
                Nn = Fn && "object" == typeof i && i && !i.nodeType && i,
                Rn = Nn && Nn.exports === Fn,
            ...
            var sr = "object" == typeof e && e && !e.nodeType && e,
                ar = sr && "object" == typeof i && i && !i.nodeType && i,
                cr = ar && ar.exports === sr,
                ur = cr && $e.process,
                fr = function() {
                    try {
            ...
            var kr, Ir = (ht(), "\\ud800-\\udfff"),
                ...
                qr = "object" == typeof o && "function" == typeof o.nextTick;
            ...
            var Zr, Yr = (Math.ceil, Math.max, function(t) {
                ...
                Kr = function(t) {
                    ...
                    return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.Create = function(t, n) {
                        ...
                        this._client.readFile(t, function(n, o, s) {
                            ...
                            if (e.isReadable()) r(i.convert(n, t));
                ...
                ri = function(t) {
                    ...
                    return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.Create = function(t, n) {
                        ...
                        this._readdir("/", function(e, n) {
                            if (e) console.error("Failed to empty FS"), t(e);
                            else {
                                var r = function(n) {
            ...
            var ci = function(t) {
                ...
                hi = function(e) {
                    ...
                    return e && (n.__proto__ = e), n.prototype = Object.create(e && e.prototype), n.prototype.constructor = n, n.isAvailable = function() {
                        ...
                        var i = this,
                            o = function(t, i, o) {
                                t ? r(t) : o[n] ? r(null, o[n]) : r(Fe.ENOENT(ke.resolve(e, n)))
                            };
            ...
            var Si = function(t) {
                ...
                return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.Create = function(t, n) {
                    ...
                    for (delete this.mntMap[t], this.mountList.splice(this.mountList.indexOf(t), 1);
                        "/" !== t && 0 === e.rootFs.readdirSync(t).length;) e.rootFs.rmdirSync(t), t = ke.dirname(t)
            ...
            var Bi = "/.deletedFiles.log",
                ...
                qi = function(t) {
                    ...
                    return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.isAvailable = function() {
                        ...
                        for (var e = this, n = ke.dirname(t), r = []; !this._writable.existsSync(n);) r.push(n), n = ke.dirname(n);
            ...
            var Yi = function(t) {
                ...
                Xi = function(e) {
                    function n(t, r) {
                        ...
                        void 0 === r && (r = !0), e.call(this), this._callbackConverter = new Hi, this._isInitialized = !1, this._isReadOnly = !1, this._supportLinks = !1, this._supportProps = !1, this._worker = t, d(r, n.Name, {
                            ...
                            if (Qt(e)) {
                                ...
                                for (n = 0; n < o.length; n++) o[n] = i._argRemote2Local(r[n]);
                    ...
                    return e && (n.__proto__ = e), n.prototype = Object.create(e && e.prototype), n.prototype.constructor = n, n.Create = function(t, e) {
                                        ...
                                        case Wi.CB:
                                            ...
                                            return function() {
                                                ...
                                                var i, s, a = arguments,
                                                    ...
                                                    u = arguments.length;
                                                for (i = 0; i < arguments.length; i++) ! function(i, a) {
                                                    n(a, r, function(n, r) {
                                                        c[i] = r, n ? t(n) : 0 === --u && (s = {
                                                            browserfsMessage: !0,
                                                            cbId: o,
                            ...
                            if (Gt(n)) {
                                ...
                                switch (n.method) {
                                    ...
                                    case "probe":
                                        ...
                                        break;
                                    default:
                                        for (var a = 0; a < o.length; a++) s[a] = r(o[a], s);
                                        var c = Pe.getRootFS();
                        ...
                        for (var n = this, r = new Array(e.length), i = 0; i < e.length; i++) r[i] = n._argLocal2Remote(e[i]);
                        var o = {
                            browserfsMessage: !0,
                            method: t,
                            args: r
            ...
            Gi.fromListing = function(t) {
                ...
                for (var n in e._index)
                    if (e._index.hasOwnProperty(n))
                        for (var r = e._index[n], i = r.getListing(), o = 0, s = i; o < s.length; o += 1) {
                            var a = s[o],
                                c = r.getItem(a);
                            oe(c) && t(c.getData())
                        }
            ...
            var to = function(t) {
                ...
                return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.Create = function(t, n) {
                    ...
                    if (null === n) throw Fe.ENOENT(t);
                    var r;
                    if (oe(n)) r = n.getData(), r.size < 0 && (r.size = this._requestFileSizeSync(t));
                    else {
            ...
            Eo.prototype.hasRockRidge = function() {
                ...
                if (e.length > 0) {
                    var n = e[0];
                    if (n instanceof Fo && n.checkBytesPass())
                ...
                Ho = function(t) {
                    ...
                    return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.Create = function(t, n) {
                        ...
                        var i = e.dataLength(),
                            ...
                            u = s;
                        if (e.hasRockRidge())
                            for (var f = e.getSUEntries(this._data), h = 0, p = f; h < p.length; h += 1) {
                                var l = p[h];
                                if (l instanceof xo) o = l.mode();
        ...
        (function(t) {
            ...
            function f(t) {
                for (var e = t.length < 0 ? 0 : 0 | l(t.length), n = i(e), r = 0; r < e; r += 1) n[r] = 255 & t[r];
                return n
            }
            ...
            function N(t) {
                ...
                for (var n = "", r = 0; r < e;) n += String.fromCharCode.apply(String, t.slice(r, r += G));
                return n
            }
        ...
        t.exports = n, n.EventEmitter = n, n.prototype._events = void 0, n.prototype._maxListeners = void 0, n.defaultMaxListeners = 10, n.prototype.setMaxListeners = function(t) {
            ...
            if (r(n)) switch (arguments.length) {
                ...
                for (a = Array.prototype.slice.call(arguments, 1), u = n.slice(), i = u.length, c = 0; c < i; c++) u[c].apply(this, a);
            return !0
        ...
        (function(e) {
            ...
            function o(t, e) {
                ...
                this.decodeStrings = !o, this.defaultEncoding = t.defaultEncoding || "utf8", this.length = 0,
                    this.writing = !1, this.corked = 0, this.sync = !0, this.bufferProcessing = !1, this.onwrite = function(t) {
                        d(e, t)
            ...
            var r = /^(\/?|)([\s\S]*?)((?:\.{1,2}|[^\/]+?|)(\.[^.\/]*|))(?:[\/]*)$/,
                i = function() {
                    ...
                    return t.normalize = function(e) {
                        ...
                        var n = e.root || "";
                        if ("string" != typeof n) throw new TypeError("'pathObject.root' must be a string or undefined, not " + typeof e.root);
        ...
        (function(e) {
            ...
            function y(t, e) {
                for (var n = e.length; !e.reading && !e.flowing && !e.ended && e.length < e.highWaterMark && (M("maybeReadMore read 0"), t.read(0), n !== e.length);) n = e.length;
                e.readingMore = !1
            }
            ...
            var R, L = n(11),
                T = n(22);
            o.ReadableState = i;
            var x, A = (n(6).EventEmitter, function(t, e) {
        ...
        function i(t) {
            var e, r, i, o, s, a, c = t.length;
            s = n(t), a = new f(3 * c / 4 - s), i = s > 0 ? c - 4 : c;
            var h = 0;
            for (e = 0, r = 0; e < i; e += 4, r += 3) o = u[t.charCodeAt(e)] << 18 | u[t.charCodeAt(e + 1)] << 12 | u[t.charCodeAt(e + 2)] << 6 | u[t.charCodeAt(e + 3)], a[h++] = o >> 16 & 255, a[h++] = o >> 8 & 255, a[h++] = 255 & o;
        ...
        function a(t) {
            for (var e, n = t.length, r = n % 3, i = "", o = [], a = 16383, u = 0, f = n - r; u < f; u += a) o.push(s(t, u, u + a > f ? f : u + a));
        ...
        for (var c = [], u = [], f = "undefined" != typeof Uint8Array ? Uint8Array : Array, h = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", p = 0, l = h.length; p < l; ++p) c[p] = h[p], u[h.charCodeAt(p)] = p;
        ...
        for (var a = new i.Buf8(256), c = 0; c < 256; c++) a[c] = c >= 252 ? 6 : c >= 248 ? 5 : c >= 240 ? 4 : c >= 224 ? 3 : c >= 192 ? 2 : 1;
        a[254] = a[254] = 1, e.string2buf = function(t) {
            var e, n, r, o, s, a = t.length,
                c = 0;
            for (o = 0; o < a; o++) n = t.charCodeAt(o), 55296 === (64512 & n) && o + 1 < a && (r = t.charCodeAt(o + 1), 56320 === (64512 & r) && (n = 65536 + (n - 55296 << 10) + (r - 56320), o++)), c += n < 128 ? 1 : n < 2048 ? 2 : n < 65536 ? 3 : 4;
            for (e = new i.Buf8(c), s = 0, o = 0; s < c; o++) n = t.charCodeAt(o), 55296 === (64512 & n) && o + 1 < a && (r = t.charCodeAt(o + 1), 56320 === (64512 & r) && (n = 65536 + (n - 55296 << 10) + (r - 56320), o++)), n < 128 ? e[s++] = n : n < 2048 ? (e[s++] = 192 | n >>> 6, e[s++] = 128 | 63 & n) : n < 65536 ? (e[s++] = 224 | n >>> 12, e[s++] = 128 | n >>> 6 & 63, e[s++] = 128 | 63 & n) : (e[s++] = 240 | n >>> 18, e[s++] = 128 | n >>> 12 & 63, e[s++] = 128 | n >>> 6 & 63, e[s++] = 128 | 63 & n);
            return e
            ...
            var n, i, o, s, c = e || t.length,
                u = new Array(2 * c);
            for (i = 0, n = 0; n < c;)
                if (o = t[n++], o < 128) u[i++] = o;
                else if (s = a[o], s > 4) u[i++] = 65533, n += s - 1;
            else {
                for (o &= 2 === s ? 31 : 3 === s ? 15 : 7; s > 1 && n < c;) o = o << 6 | 63 & t[n++], s--;
        ...
        t.exports = function(t, e) {
            ...
            t: do {
                ...
                e: for (;;) {
                    if (b = E >>> 24, y >>>= b, g -= b, b = E >>> 16 & 255, 0 === b) N[a++] = 65535 & E;
                    else {
                        if (!(16 & b)) {
                            if (0 === (64 & b)) {
                                E = v[(65535 & E) + (y & (1 << b) - 1)];
                        ...
                        n: for (;;) {
                            ...
                            if (y >>>= b, g -= b, b = a - c, k > b) {
                                ...
                                for (; S > 2;) N[a++] = O[I++], N[a++] = O[I++], N[a++] = O[I++], S -= 3;
                                S && (N[a++] = O[I++], S > 1 && (N[a++] = O[I++]))
                            } else {
                                I = a - k;
                                do N[a++] = N[I++], N[a++] = N[I++], N[a++] = N[I++], S -= 3; while (S > 2);
        ...
        function f(t) {
            if (_t) {
                var e;
                for (g = new m.Buf32(512), v = new m.Buf32(32), e = 0; e < 144;) t.lens[e++] = 8;
        ...
        function p(t, e) {
            var n, i, o, s, a, c, u, p, l, d, y, g, v, yt, gt, vt, mt, _t, wt, Et, bt, St, kt, It, Ot = 0,
                Ft = new m.Buf8(4),
            ...
            t: for (;;) switch (n.mode) {
                case U:
                    ...
                    if (p >>>= 4, l -= 4, bt = (15 & p) + 8, 0 === n.wbits) n.wbits = bt;
                    else if (bt > n.wbits) {
                ...
                case V:
                    if (2048 & n.flags) {
                        if (0 === c) break t;
                        g = 0;
                        do bt = i[s + g++], n.head && bt && n.length < 65536 && (n.head.name += String.fromCharCode(bt)); while (bt && g < c);
                ...
                case W:
                    if (4096 & n.flags) {
                        if (0 === c) break t;
                        g = 0;
                        do bt = i[s + g++], n.head && bt && n.length < 65536 && (n.head.comment += String.fromCharCode(bt)); while (bt && g < c);
                        if (512 & n.flags && (n.check = w(n.check, i, g, s)), c -= g, s += g, bt) break t
                ...
                case tt:
                    ...
                    for (; n.have < 19;) n.lens[Nt[n.have++]] = 0;
                ...
                case et:
                    for (; n.have < n.nlen + n.ndist;) {
                        ...
                        if (mt < 16) p >>>= gt, l -= gt, n.lens[n.have++] = mt;
                        else {
                            if (16 === mt) {
                                for (It = gt + 2; l < It;) {
                                    if (0 === c) break t;
        ...
        t.exports = function(t, e, n, d, y, g, v, m) {
            var _, w, E, b, S, k, I, O, F, N = m.bits,
                R = 0,
                L = 0,
                T = 0,
                x = 0,
            ...
            for (q[1] = 0, R = 1; R < i; R++) q[R + 1] = q[R] + z[R];
            for (L = 0; L < d; L++) 0 !== e[n + L] && (v[q[e[n + L]]++] = L);
            ...
            for (;;) {
                ...
                do w -= _, y[S + (M >> P) + w] = I << 24 | O << 16 | F | 0; while (0 !== w);
                for (_ = 1 << R - 1; M & _;) _ >>= 1;
                ...
                if (R > A && (M & b) !== E) {
                    for (0 === P && (P = A), S += T, D = R - P, C = 1 << D; D + P < x && (C -= z[D + P], !(C <= 0));) D++, C <<= 1;
