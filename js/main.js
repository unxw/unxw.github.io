...
document.addEventListener('DOMContentLoaded', function() { //document (the page), add listener for an event (in this case its DOM (aka the document) kinda), which then calls to any function following it
...
*/
    ...
    console.log('%call scripts loaded okay!🌸\nwindow location:'+window.location.href,'color: #ffc4f3; font-size: 20px;'); //ts doesnt even check to see if it loaded just pray for the best ngl